...
int c=in.nextInt();// for class type;
System.out.println("Please enter no. of tickets");
int t=in.nextInt();//no of tickets
...
public void doCancel()//for cancellation of tickets;
{
...
if(cl[i]==1)
{
System.out.println(pno[i]+"\t"+name[i]+"\t\t"+age[i]);
}
}
